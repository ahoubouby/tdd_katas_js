...
This kata demonstrates basic way to start with tdd

All tests should always pass, regardless of environment conditions.

write a function call it `verifyPass` take first input as a string and second as table of rules to impelements
